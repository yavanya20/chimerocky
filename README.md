...
And also, its kinda broken. I reccomend to use UKi.

**How to use UKI to boot?** ok, it is kinda easy. First, make sure you have this path /boot/EFI/BOOT. Then, copy your kernel executable directly to that fallback name:
```
